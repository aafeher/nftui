...
| File | Package | Builds |
|------|---------|--------|
| `nftui-1.0.0.ebuild` | `net-firewall/nftui` | from source via `go-module.eclass` |
| `nftui-bin-1.0.0.ebuild` | `net-firewall/nftui-bin` | installs the prebuilt release binary |
...
cp nftui-bin-1.0.0.ebuild metadata.xml <overlay>/net-firewall/nftui-bin/
