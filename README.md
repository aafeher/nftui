...
| **UDP / UDPLITE** | sport, dport, length (UDP) / csumcov (UDP-Lite checksum coverage — the same wire cell, renamed from the `meta l4proto` context; `udplite length` does not exist), checksum |
